# EMPATHY INTERVIEW SIMULATOR - DEPLOYMENT VERSION
...
def start_conversation():
    try:
        ...
        conversations[session_id]["messages"].append({"role": "assistant", "content": msg, "timestamp": datetime.now().isoformat()})
...
def send_message():
    try:
        data = request.json
        session = conversations[data['session_id']]
...
if __name__ == '__main__':
    ...
    print("\n" + "="*60)
    print("EMPATHY INTERVIEW SIMULATOR - READY TO DEPLOY")
    print("="*60)
    print(f"\nAccess codes: {', '.join(VALID_ACCESS_CODES)}")
    print(f"\n1. Open browser: http://localhost:{port}")
    print("2. Use code: TEST123\n")
    print("="*60 + "\n")
